...
public class Main {
    ...
    private static void makeTestData() {
        ...
        articles.add(new Article(1, Util.getNowStr(), Util.getNowStr(), "테스트 제목 a", "테스트 제목"));
        articles.add(new Article(2, Util.getNowStr(), Util.getNowStr(), "테스트 제목 1", "테스트 제목"));
        articles.add(new Article(3, Util.getNowStr(), Util.getNowStr(), "테스트 제목 가", "테스트 제목"));
    }
